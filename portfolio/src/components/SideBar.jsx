...
export default function SideBar() {
  return (
    <VerticalOverlayBar>
      <IconLink href="#resume" title="Resume">
      ...
      <IconLink href="https://linkedin.com/in/yourprofile" target="_blank" title="LinkedIn">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
      ...
      <IconLink href="https://github.com/yourprofile" target="_blank" rel="noopener noreferrer" title="Github">
